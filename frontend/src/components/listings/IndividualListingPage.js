        ...
        {images.length > 0 && (
          <div className="border-t border-gray-200 pt-6">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Custom Options (Optional)</h3>
              <p className="text-sm text-gray-600 mb-4">Add your own description or specific colors to override the selected designer and color scheme</p>
